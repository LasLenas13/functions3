...
numbers.forEach((elem, i) => console.log(elem/2))
...
const placesThatEndWithI = cities.filter((city) => {
  return city.endsWith('i')
})

console.log(placesThatEndWithI)
...
fruits.forEach((fruit, index) => {
  ...
  } else if (fruit.name === 'orange' && fruit.color === 'orange') {
...
let totalPrice = foods.reduce((sum, food) => {
